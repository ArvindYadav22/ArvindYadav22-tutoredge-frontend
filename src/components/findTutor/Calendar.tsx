...
const Calendar: React.FC<CalendarProps> = ({ month, year, availableDates, selectedDates, onSelectDate }) => {
          ...
          return (
            <div
              ...
              style={{
                ...
                color: isAvailable ? (isSelected ? 'white' : 'black') : '#ccc',
                cursor: isAvailable ? 'pointer' : 'default',
                userSelect: 'none',
                border: isSelected ? '2px solid #0056b3' : '1px solid transparent',
              }}
            >
